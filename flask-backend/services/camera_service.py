...
def _normalize_picamera_frame(frame):
    """
    Normalize PiCamera2 frames to proper BGR format for OpenCV.
    """
...
def _open_camera():
    ...
    try:
        ...
        # Safe start without set_controls
        camera.start()
    ...
    def closer():
        ...
        with _camera_lock:
            if (
                ...
                and time.time() - _last_opened_at >= _CAMERA_KEEPALIVE_SECONDS
            ):
                _close_camera()
    ...
    with _camera_lock:
        ...
        try:
            ...
            if _camera_kind == "picamera2":
                ...
                output = _normalize_picamera_frame(
                    _camera_handle.capture_array()
                )
            ...
            # Read a couple frames for stabilization
            for _ in range(2):
                ok, frame = _camera_handle.read()
