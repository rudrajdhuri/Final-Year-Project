...
# # -----------------------------
# # Load Stage 1 (Animal vs Non-Animal)
# # -----------------------------
...
#     # 🔵 Case 2: Model confused between two animals
#     if gap < 0.15:
